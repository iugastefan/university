...
labels = [random.randint(0, 5) for i in
          range(num_samples)]  # generam etichetele, numere naturale intre 0 si 5 => 6 clase

num_neurons = [7, 8]  # numarul de perceptroni de pe primul si al doilea strat
net = MLPClassifier(hidden_layer_sizes=num_neurons, activation='tanh', solver='sgd', learning_rate_init=0.01,
                    max_iter=1)
...
print('functia de activare de pe ultimul strat:',
      net.out_activation_)  # functie de activare a fost adaugata automant in functie de numarul de clase
...
print('numarul de perceptroni de pe ultimul strat:',
      net.n_outputs_)  # numarul de perceptroni de pe ultimul strat = numarul de clase - pentru clasificare multiclass
# 1 perceptron pentru clasificare binara
