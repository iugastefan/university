...
def Simplex(A, b, c):
    ...
    basicSize = len(A)  # number of constraints, m
    nonbasicSize = len(A[0]) - basicSize  # n-m, number of variables
    ...
    while True:
        ...
        cindx[cnMinIndx], cindx[ratioMinIndx +
                                nonbasicSize] = cindx[ratioMinIndx + nonbasicSize], cindx[cnMinIndx]


print("Minimizam cᵀx")
print("Conditii Ax = b, x ≥ 0")
A = np.array([
    [3,  2,  1,  1,  0],
    [2,  5,  3,  0,  1],
])
