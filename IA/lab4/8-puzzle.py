...
graf = Graf(start, scop)

print("Configuratia initiala: ", graf.nod_start)
print("Configuratia scop: ", graf.afis_scop)

print("Configuratia initiala lista: ", graf.nod_start.info)
print("Configuratia scop lista: ", graf.afis_scop.info)

while not graf.scop(graf.nod_start):
    pass
    ind1 = int(input("Indice 1: "))
    ind2 = int(input("Indice 2: "))
    if 0 <= ind1 <= 8 and 0 <= ind2 <= 8 and (graf.nod_start.info[ind1] == 0 or graf.nod_start.info[ind2] == 0) and \
            ind1 - ind2 in [-1, 1, -3, 3]:
        graf.nod_start.info = graf.interschimba(ind1, ind2, graf.nod_start.info)
        print("Configuratia initiala: ", graf.nod_start)
        print("Configuratia scop: ", graf.afis_scop)
    else:
        print("Indicii sunt incorecti")
